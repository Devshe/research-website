    ...
    <div className="App">
      ...
      <section id="domain" className="section domain">
        ...
        <div className="domain-subsection" id="research-gap">
          <h3>Research Gap</h3>
          <p>
            We have identified gaps in the existing research, particularly in
            the integration of AI technologies with traditional software
            engineering practices. The lack of standard methodologies for
            AI-driven software testing is a significant gap that this research
            aims to address.
          </p>
        </div>
        <div className="domain-subsection" id="research-problem">
          ...
          <p>
            Golang’s rise in popularity is hindered by the lack of a stable ODM
            ...
            to rely on MongoDB’s official Go driver, which requires repetitive
            and error-prone low-level coding for basic tasks like CRUD
            operations and pagination. This increases cognitive complexity and
            reduces productivity. Additionally, Go lacks advanced ODM features
            common in other languages, such as schema validation, instance
            methods, and transaction management, which leads to fragmented code
            and a higher likelihood of bugs. The absence of a plugin
            architecture further limits customization and flexibility, while the
            lack of support for distributed transactions and cross-database
            aggregation impedes the development of scalable applications. The
            proposed Elemental system aims to address these gaps by providing a
            stable, feature-rich ODM with support for schema validation, plugin
            architecture, efficient query building, and distributed transaction
            management, ultimately enhancing the maintainability and scalability
            of applications built with Go and MongoDB.
          </p>
        </div>
